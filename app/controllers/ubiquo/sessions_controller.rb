class Ubiquo::SessionsController < ApplicationController
  ...
  def create
    ...
    if logged_in?
      if params[:remember_me] == "1"
        ...
        cookies[:auth_token] = { :value => self.current_ubiquo_user.remember_token , :expires => self.current_ubiquo_user.remember_token_expires_at }
      end
  ...
  # logout method. Destroy all ubiquo_user data and send ubiquo_user to ubiquo_home (which commonly is login_required)
  def destroy
